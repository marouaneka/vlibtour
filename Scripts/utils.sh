...
export TOURMANAGEMENTENTITY=${VLIBTOUR}/vlibtour-tour-management-system/vlibtour-tour-management-entity/1.0-SNAPSHOT/vlibtour-tour-management-entity-1.0-SNAPSHOT.jar
export TOURMANAGEMENTAPI=${VLIBTOUR}/vlibtour-tour-management-system/vlibtour-tour-management-api/1.0-SNAPSHOT/vlibtour-tour-management-api-1.0-SNAPSHOT.jar
export TOURMANAGEMENTBEAN=${VLIBTOUR}/vlibtour-tour-management-system/vlibtour-tour-management-bean/1.0-SNAPSHOT/vlibtour-tour-management-bean-1.0-SNAPSHOT.jar
export TOURMANAGEMENTADMINCLIENT=${VLIBTOUR}/vlibtour-tour-management-system/vlibtour-tour-management-admin-client/1.0-SNAPSHOT/vlibtour-tour-management-admin-client-1.0-SNAPSHOT.jar
...
export LOBBYROOMPROXY=${VLIBTOUR}/vlibtour-lobby-room-system/vlibtour-lobby-room-proxy/1.0-SNAPSHOT/vlibtour-lobby-room-proxy-1.0-SNAPSHOT.jar

export GROUPCOMMUNICATIONPROXY=${VLIBTOUR}/vlibtour-group-communication-system/vlibtour-group-communication-proxy/1.0-SNAPSHOT/vlibtour-group-communication-proxy-1.0-SNAPSHOT.jar
...
export VISITEMULATIONSERVER=${VLIBTOUR}/vlibtour-visit-emulation-system/vlibtour-visit-emulation-server/1.0-SNAPSHOT/vlibtour-visit-emulation-server-1.0-SNAPSHOT.jar
export VISITEMULATIONPROXY=${VLIBTOUR}/vlibtour-visit-emulation-system/vlibtour-visit-emulation-proxy/1.0-SNAPSHOT/vlibtour-visit-emulation-proxy-1.0-SNAPSHOT.jar
