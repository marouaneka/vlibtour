...
CLASSPATH=${CLASSPATH}${PATHSEP}${VISITCOMMON}${PATHSEP}${GSON}${PATHSEP}${GEOCALC}${PATHSEP}${LOG4J}${PATHSEP}${VISITEMULATIONSERVER}${PATHSEP}${JERSEYHTTP}${PATHSEP}${JERSEYJSON}${PATHSEP}
