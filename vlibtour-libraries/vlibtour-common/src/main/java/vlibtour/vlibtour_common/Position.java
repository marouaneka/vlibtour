...
public class Position {
	 ...
	 * for discovering how easy it is to serialie and deserialise using Gson.
	 */
	...
	/**
	 * constructs a position from a given string of position.
	 * 
	 * @param stringPos       the string of the position.
	 */
	public Position (String stringPos) {
		Position pos = GSON.fromJson(stringPos, Position.class);
		this.name = pos.name;
		this.gpsPosition = pos.gpsPosition;
	...
	public String jsonString() {
		Position pos = new Position(this.name,this.gpsPosition,this.description);
