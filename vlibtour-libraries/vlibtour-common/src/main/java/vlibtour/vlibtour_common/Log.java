 ...
 * 
 * Logging levels are: TRACE, DEBUG, INFO, WARN, ERROR, FATAL.
 * 
 * Create new loggers as needed.
 * 
 * @author Denis Conan
 * 
 */
public final class Log {
	...
	/**
	 * name of the logger for the emulation system.
	 */
	public static final String LOGGER_NAME_EMULATION = "emulation";
	/**
	 * logger object for the emulation system.
	 */
