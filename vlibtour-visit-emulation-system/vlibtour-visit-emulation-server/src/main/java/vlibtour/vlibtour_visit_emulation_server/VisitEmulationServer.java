...
public final class VisitEmulationServer {
	 ...
	 * 
	 * @param args command line arguments. There is no command line arguments.
	...
	public static void main(final String[] args) throws IOException, InterruptedException {
		...
		// Generate a graph of positions and inform/set all the clients of/to this
		// graph.
		...
		// Adapt this part if you want more users.
		...
		// Create a resource configuration that scans for JAX-RS resources and
		// providers in the server package.
...
//		server.shutdownNow();
	...
	/**
	 * steps to the next position in the current path, i.e. towards the next POI. It
	 * returns the new position of the user, or the same if the end of the path is
	 * already reached.
	 * 
	 * @param user the identifier of the user.
